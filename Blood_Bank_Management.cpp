    ...
    char t; //t-type
        void d_register()
        {
            ...
            while (1)
            {
                ...
                else if((strcmp(str,"A"))==0 || (strcmp(str,"a") == 0) || (strcmp(str,"B")) == 0 || (strcmp(str,"b")) == 0 || (strcmp(str,"O")) == 0 || (strcmp(str,"o")) == 0) {
                    t=str[0];
                    break;
                }
                else{
...
void accept(){
    ...
    if (flag!=0)
    {
        cout<<"Cost of the required Blood Packet: " << flag;
        h[hid].payment_check();
    }
    else{
...
int main(){
    ...
    while(count < 3)
    {
        ...
        if (count==3)
        {
            cout<<"Invalid acess attempted beyond 3 times, exiting";
            return 1;
        }
